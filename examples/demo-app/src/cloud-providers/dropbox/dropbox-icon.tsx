...
import type {IconProps} from '@kepler.gl/cloud-providers';

interface DropboxIconProps extends IconProps {
  colors?: string[];
  predefinedClassName?: string;
  totalColor?: number;
}

class DropboxIcon extends Component<DropboxIconProps> {
  static defaultProps: DropboxIconProps = {
    height: '16px',
