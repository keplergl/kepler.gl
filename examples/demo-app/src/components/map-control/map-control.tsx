...
interface StyledPanelActionProps {
  active?: boolean;
}

const StyledPanelAction = styled.div<StyledPanelActionProps>`
  border-radius: 2px;
  margin-left: 4px;
  padding: 5px;
  font-weight: 500;
...
export function SampleMapPanel(props: {currentSample: CurrentSample}) {
