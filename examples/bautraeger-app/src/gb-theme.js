...
// GB CHANGE - Color of GB Logo on sidepanel
// export const logoColor = activeColor;
export const logoColor = "#FFF"; 
...
export const secondaryBtnBgd = '#6A7485'; // Add Data Button, Side Panel in out Button, Add Map Style Button
export const secondaryBtnActBgd = '#A0A7B4';
export const secondaryBtnColor = '#FFFFFF'; //Nonhover text of Add Data Button, Nonhover text of Add Map Style Button
export const secondaryBtnActColor = '#FFFFFF';
export const secondaryBtnBgdHover = '#A0A7B4';
export const secondaryBtnBorder = '0';

export const ctaBtnBgd = '#0F9668';  //Fetch button on "Add Data to Map panel"
...
export const linkBtnBgd = 'transparent'; //Login button on "Add Data to Map panel/Load from Storage"
...
export const inputPlaceholderColor = '#6A7485'; //On Base Map 3D Building Color Text
...
export const sidePanelHeaderBg = '#4d5d54'; //Side Panel Header
...
export const sidePanelBg = '#738678'; //Side Panel Button
export const sidePanelScrollBarWidth = 10;
export const sidePanelScrollBarHeight = 10;
export const sideBarCloseBtnBgd = secondaryBtnBgd; //Side panel close button
...
export const panelBackground = '#29323C'; //Interactions background of tiles (eg. Tooltip), Base Map Map theme selector
export const panelContentBackground = '#292E36'; // Interactions and Base Map big panel backgrounds
...
export const panelHeaderIcon = '#6A7485'; // In Base Map Arrows and Eyes
...
export const mapPanelBackgroundColor = '#242730'; //Background of Legend
export const mapPanelHeaderBackgroundColor = '#29323C'; //Background of Legend header
export const tooltipBg = '#3A414C'; //Hover tooltips
