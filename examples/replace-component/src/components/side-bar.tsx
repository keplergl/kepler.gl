...
const CloseButtonFactory = () => {
  const CloseButton = ({onClick, isOpen}: {onClick?: () => void; isOpen?: boolean}) => (
...
function CustomSidebarFactory(CloseButton: any) {
  const SideBar = (SidebarFactory as (...args: any[]) => any)(CloseButton);
