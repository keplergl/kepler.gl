...
} from '../../demo-app/src/data/sample-trip-data';
// import sampleGeojson from '../../demo-app/src/data/sample-small-geojson';
import sampleGeojsonPoints from '../../demo-app/src/data/sample-geojson-points';
import sampleGeojsonConfig from '../../demo-app/src/data/sample-geojson-config';
import sampleH3Data, {config as h3MapConfig} from '../../demo-app/src/data/sample-hex-id-csv';
import sampleS2Data, {
  config as s2MapConfig,
  dataId as s2DataId
} from '../../demo-app/src/data/sample-s2-data';
import sampleA5Data, {
  config as a5MapConfig,
  dataId as a5DataId
} from '../../demo-app/src/data/sample-a5-data';
...
} from '../../demo-app/src/data/sample-animate-trip-data';
import sampleGpsData from '../../demo-app/src/data/sample-gps-data';
import sampleRowData, {config as rowDataConfig} from '../../demo-app/src/data/sample-row-data';
import {sampleFlowData, config as flowDataConfig} from '../../demo-app/src/data/sample-flow-data';
