...
const config = {
  ...
  transformIgnorePatterns: [
    '/node_modules\\/(?!(.*@mapbox\\/tiny-sdf\\.*|@loaders\\.gl|@deck\\.gl|@deck\\.gl-community|@luma\\.gl|@hubble\\.gl|@flowmap\\.gl|@math\\.gl|d3-.*|kdbush|preact|maplibregl-mapbox-request-transformer))',
    '\\.pnp\\.[^\\/]+$'
  ]
};
