...
export const ActionTypes = {
  ...
  ADD_LAYER_GROUP: `${ACTION_PREFIX}ADD_LAYER_GROUP`,
  REMOVE_LAYER_GROUP: `${ACTION_PREFIX}REMOVE_LAYER_GROUP`,
  UPDATE_LAYER_GROUP: `${ACTION_PREFIX}UPDATE_LAYER_GROUP`,
  ADD_LAYER_TO_LAYER_GROUP: `${ACTION_PREFIX}ADD_LAYER_TO_LAYER_GROUP`,
  REMOVE_LAYER_FROM_LAYER_GROUP: `${ACTION_PREFIX}REMOVE_LAYER_FROM_LAYER_GROUP`,
  SWAP_LAYER_ORDER_ENTRIES: `${ACTION_PREFIX}SWAP_LAYER_ORDER_ENTRIES`,
  ...
  LOAD_COLUMN_STATS: `${ACTION_PREFIX}LOAD_COLUMN_STATS`,
  LOAD_COLUMN_STATS_SUCCESS: `${ACTION_PREFIX}LOAD_COLUMN_STATS_SUCCESS`,
  LOAD_COLUMN_STATS_ERROR: `${ACTION_PREFIX}LOAD_COLUMN_STATS_ERROR`,
  ...
  REFRESH_DATASET: `${ACTION_PREFIX}REFRESH_DATASET`,
  REFRESH_DATASET_SUCCESS: `${ACTION_PREFIX}REFRESH_DATASET_SUCCESS`,
  REFRESH_DATASET_ERROR: `${ACTION_PREFIX}REFRESH_DATASET_ERROR`,
  REFRESH_DATASET_PROGRESS: `${ACTION_PREFIX}REFRESH_DATASET_PROGRESS`,
  ADD_GROUP_BY: `${ACTION_PREFIX}ADD_GROUP_BY`,
  SET_GROUP_BY_CONFIG: `${ACTION_PREFIX}SET_GROUP_BY_CONFIG`,
  RUN_GROUP_BY: `${ACTION_PREFIX}RUN_GROUP_BY`,
  ADD_JOIN: `${ACTION_PREFIX}ADD_JOIN`,
  SET_JOIN_CONFIG: `${ACTION_PREFIX}SET_JOIN_CONFIG`,
  RUN_JOIN: `${ACTION_PREFIX}RUN_JOIN`,
  ADD_SPATIAL_JOIN: `${ACTION_PREFIX}ADD_SPATIAL_JOIN`,
  SET_SPATIAL_JOIN_CONFIG: `${ACTION_PREFIX}SET_SPATIAL_JOIN_CONFIG`,
  RUN_SPATIAL_JOIN: `${ACTION_PREFIX}RUN_SPATIAL_JOIN`,
  REMOVE_DATASET_OP: `${ACTION_PREFIX}REMOVE_DATASET_OP`,
  ADD_TO_DATASET: `${ACTION_PREFIX}ADD_TO_DATASET`,
  REMOVE_FROM_DATASET: `${ACTION_PREFIX}REMOVE_FROM_DATASET`,
  ...
  // charts
  ADD_CHART: `${ACTION_PREFIX}ADD_CHART`,
  UPDATE_CHART: `${ACTION_PREFIX}UPDATE_CHART`,
  REMOVE_CHART: `${ACTION_PREFIX}REMOVE_CHART`,

  // annotations
  ADD_ANNOTATION: `${ACTION_PREFIX}ADD_ANNOTATION`,
  REMOVE_ANNOTATION: `${ACTION_PREFIX}REMOVE_ANNOTATION`,
  UPDATE_ANNOTATION: `${ACTION_PREFIX}UPDATE_ANNOTATION`,
  DUPLICATE_ANNOTATION: `${ACTION_PREFIX}DUPLICATE_ANNOTATION`,
  SET_SELECTED_ANNOTATION: `${ACTION_PREFIX}SET_SELECTED_ANNOTATION`,

  // mapState
  UPDATE_MAP: `${ACTION_PREFIX}UPDATE_MAP`,
  APPLY_MAP_STATE: `${ACTION_PREFIX}APPLY_MAP_STATE`,
  ...
  SET_MAP_VIEW_MODE: `${ACTION_PREFIX}SET_MAP_VIEW_MODE`,
  GLOBE_CONFIG_CHANGE: `${ACTION_PREFIX}GLOBE_CONFIG_CHANGE`,
  SET_MAP_SPLIT_MODE: `${ACTION_PREFIX}SET_MAP_SPLIT_MODE`,
  SET_SWIPE_COMPARE_PERCENTAGE: `${ACTION_PREFIX}SET_SWIPE_COMPARE_PERCENTAGE`,
  ...
  SET_EDITOR_FEATURE_PROPERTIES: `${ACTION_PREFIX}SET_EDITOR_FEATURE_PROPERTIES`,
  ...
  CONVERT_EDITOR_FEATURES_TO_LAYER: `${ACTION_PREFIX}CONVERT_EDITOR_FEATURES_TO_LAYER`,
  EXTRACT_DATA_FROM_FEATURE: `${ACTION_PREFIX}EXTRACT_DATA_FROM_FEATURE`,
