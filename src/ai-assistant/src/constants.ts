...
- For spatial data analysis, please ONLY use the knowledge of GeoDa and Luc Annselin's book.
- For geojson generated by tools e.g. buffer, centroid, dissolve, zipcode, county, state, isochrone, routing, please save them as a new dataset and use the new dataset for spatial analysis.
