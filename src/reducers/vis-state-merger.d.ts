...
export function mergeFilters(state: VisState, filters: ParsedConfig['visState']['filters']): VisState;
export function mergeInteractions(state: VisState, interactionConfig: ParsedConfig['visState']['interactionConfig']): VisState;
export function mergeLayerBlending(state: VisState, layerBlending: ParsedConfig['visState']['layerBlending']): VisState;
