...
export default {
  ...
  tooltip: {
    ...
    pause: 'пауза',
    reset: 'перезапустить',
    showAiAssistantPanel: 'Показать ИИ-ассистент',
    hideAiAssistantPanel: 'Скрыть ИИ-ассистент'
  },
  toolbar: {
  ...
  modal: {
    ...
    shareMap: {
      ...
      cloudSubtitle: 'Войдите и загрузите данные карты в свое лич��ое облачное хранилище',
      shareDisclaimer:
