...
export default {
  ...
  tooltip: {
    ...
    '3DMap': '3D Карта',
    mapViewMode: 'Режим отображения карты',
    mapViewMode2D: '2D',
    mapViewMode3D: '3D',
    mapViewModeGlobe: 'Глобус',
...
`,
  ...
  color: {
    ...
    disableStepReason:
      'Невозможно изменить количество шагов с пользовательскими цветовыми переходами, используйте пользовательскую палитру для редактирования шагов',
