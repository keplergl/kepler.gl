...
You can load a GeoJSON file (with a single [`Feature`](https://tools.ietf.org/html/rfc7946#section-3.2) or a [`FeatureCollection`](https://tools.ietf.org/html/rfc7946#section-3.3)), newline-delimited GeoJSON (`.geojsonl`), KML, GPX, TCX, Shapefile, FlatGeobuf, or a GeoArrow file. KML, GPX, TCX, GeoJSONL, Shapefile, and FlatGeobuf are converted to GeoJSON features.
