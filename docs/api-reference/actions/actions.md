...
-   [visStateActions][46]
    ...
    -   [addLayer][49]
    -   [enlargeFilter][51]
    -   [interactionConfigChange][53]
    -   [layerConfigChange][55]
    -   [layerTextLabelChange][57]
    -   [layerTypeChange][59]
    -   [layerVisConfigChange][61]
    -   [layerVisualChannelConfigChange][63]
    -   [onLayerClick][65]
    -   [onLayerHover][67]
    -   [onMapClick][69]
    -   [removeDataset][70]
...
-   **Updaters**: [`combinedUpdaters.loadFilesUpdater`][167]
...
-   **Updaters**: [`combinedUpdaters.loadFilesErrUpdater`][168]
...
-   **ActionTypes**: [`ActionTypes.LOAD_FILES_SUCCESS`][12]
-   **Updaters**: [`combinedUpdaters.loadFilesSuccessUpdater`][169]

**Parameters**

-   `payload` **[Object][154]** 
    -   `payload.data` **[Object][154]** data to load
    -   `payload.info` **[Object][154]** meta information about data

Returns **{type: ActionTypes.LOAD_FILES_SUCCESS, payload: any}** 
...
-   **Updaters**: [`mapStateUpdaters.receiveMapConfigUpdater`][170], [`mapStyleUpdaters.receiveMapConfigUpdater`][171], [`visStateUpdaters.receiveMapConfigUpdater`][172]
...
-   **Updaters**: [`mapStyleUpdaters.resetMapConfigMapStyleUpdater`][173], [`visStateUpdaters.resetMapConfigVisStateUpdater`][174]
...
-   **Updaters**: [`visStateUpdaters.addFilterUpdater`][175]
...
-   **Updaters**: [`visStateUpdaters.addLayerUpdater`][176]
...
-   **Updaters**: [`visStateUpdaters.enlargeFilterUpdater`][177]

**Parameters**

-   `idx` **[Number][178]** index of filter to enlarge
...
-   **Updaters**: [`visStateUpdaters.interactionConfigChangeUpdater`][179]
...
-   **Updaters**: [`visStateUpdaters.layerConfigChangeUpdater`][180]
...
-   **Updaters**: [`visStateUpdaters.layerTextLabelChangeUpdater`][181]

**Parameters**

-   `oldLayer` **[Object][154]** layer to be updated
-   `idx` **[Number][178]** \-`idx` of text label to be updated
...
-   **Updaters**: [`visStateUpdaters.layerTypeChangeUpdater`][182]
...
-   **Updaters**: [`visStateUpdaters.layerVisConfigChangeUpdater`][183]
...
-   **Updaters**: [`visStateUpdaters.layerVisualChannelChangeUpdater`][184]
...
-   **Updaters**: [`visStateUpdaters.layerClickUpdater`][185]
...
-   **Updaters**: [`visStateUpdaters.layerHoverUpdater`][186]
...
-   **Updaters**: [`visStateUpdaters.mapClickUpdater`][187]
...
-   **Updaters**: [`visStateUpdaters.removeDatasetUpdater`][188]
...
-   **Updaters**: [`visStateUpdaters.removeFilterUpdater`][189]

**Parameters**

-   `idx` **[Number][178]** idx of filter to be removed
...
-   **Updaters**: [`visStateUpdaters.removeLayerUpdater`][190]

**Parameters**

-   `idx` **[Number][178]** idx of layer to be removed
...
-   **Updaters**: [`visStateUpdaters.reorderLayerUpdater`][191]

**Parameters**

-   `order` **[Array][164]&lt;[Number][178]>** an array of layer indexes
...
-   **Updaters**: [`visStateUpdaters.setFilterUpdater`][192]

**Parameters**

-   `idx` **[Number][178]** \-`idx` of filter to be updated
...
-   **Updaters**: [`visStateUpdaters.setFilterPlotUpdater`][193]
...
-   **Updaters**: [`visStateUpdaters.setVisibleLayersForMapUpdater`][194]

**Parameters**

-   `mapIndex` **[Number][178]** index of the split map
...
-   **Updaters**: [`visStateUpdaters.showDatasetTableUpdater`][195]
...
-   **Updaters**: [`visStateUpdaters.toggleFilterAnimationUpdater`][196]

**Parameters**

-   `idx` **[Number][178]** idx of filter
...
-   **Updaters**: [`visStateUpdaters.toggleLayerForMapUpdater`][197]
...
-   **Updaters**: [`visStateUpdaters.updateAnimationSpeedUpdater`][198]

**Parameters**

-   `idx` **[Number][178]**  `idx` of filter
-   `speed` **[Number][178]** `speed` to change it to. `speed` is a multiplier
...
-   **Updaters**: [`visStateUpdaters.updateLayerBlendingUpdater`][199]
...
-   **Updaters**: [`combinedUpdaters.updateVisDataUpdater`][200], [`visStateUpdaters.updateVisDataUpdater`][201]
...
-   **Updaters**: [`uiStateUpdaters.addNotificationUpdater`][202]
...
-   **Updaters**: [`uiStateUpdaters.cleanupExportImage`][203]
...
-   **Updaters**: [`uiStateUpdaters.hideExportDropdownUpdater`][204]
...
-   **Updaters**: [`uiStateUpdaters.openDeleteModalUpdater`][205]
...
-   **Updaters**: [`uiStateUpdaters.removeNotificationUpdater`][206]
...
-   **Updaters**: [`uiStateUpdaters.setExportDataUpdater`][207]
...
-   **Updaters**: [`uiStateUpdaters.setExportDataTypeUpdater`][208]
...
-   **Updaters**: [`uiStateUpdaters.setExportFilteredUpdater`][209]
...
-   **Updaters**: [`uiStateUpdaters.setExportImageDataUri`][210]
...
-   **Updaters**: [`uiStateUpdaters.setExportSelectedDatasetUpdater`][211]
...
-   **Updaters**: [`uiStateUpdaters.setRatioUpdater`][212]
...
-   **Updaters**: [`uiStateUpdaters.setResolutionUpdater`][213]
...
-   **Updaters**: [`uiStateUpdaters.setUserMapboxAccessTokenUpdater`][214]
...
-   **Updaters**: [`uiStateUpdaters.showExportDropdownUpdater`][215]
...
-   **Updaters**: [`uiStateUpdaters.startExportingImage`][216]
...
-   **Updaters**: [`uiStateUpdaters.toggleLegendUpdater`][217]
...
-   **Updaters**: [`uiStateUpdaters.toggleMapControlUpdater`][218]

**Parameters**

-   `panelId` **[string][152]** map control panel id, one of the keys of: [`DEFAULT_MAP_CONTROLS`][219]
...
-   **Updaters**: [`uiStateUpdaters.toggleModalUpdater`][220]

**Parameters**

-   `id` **([string][152] | null)** id of modal to be shown, null to hide modals. One of:-   [`DATA_TABLE_ID`][221]
    -   [`DELETE_DATA_ID`][222]
    -   [`ADD_DATA_ID`][223]
    -   [`EXPORT_IMAGE_ID`][224]
    -   [`EXPORT_DATA_ID`][225]
    -   [`ADD_MAP_STYLE_ID`][226]
...
-   **Updaters**: [`uiStateUpdaters.toggleSidePanelUpdater`][227]
...
-   **Updaters**: [`mapStateUpdaters.fitBoundsUpdater`][228]

**Parameters**

-   `bounds` **[Array][164]&lt;[Number][178]>** as `[lngMin, latMin, lngMax, latMax]`
...
-   **Updaters**: [`mapStateUpdaters.togglePerspectiveUpdater`][229]
...
-   **Updaters**: [`mapStateUpdaters.toggleSplitMapUpdater`][230], [`visStateUpdaters.toggleSplitMapUpdater`][231]

**Parameters**

-   `index` **[Number][178]?** index is provided, close split map at index
...
-   **Updaters**: [`mapStateUpdaters.updateMapUpdater`][232]
...
-   `viewport` **[Object][154]** viewport object container one or any of these properties `width`, `height`, `latitude` `longitude`, `zoom`, `pitch`, `bearing`, `dragRotate`
    -   `viewport.width` **[Number][178]?** Width of viewport
    -   `viewport.height` **[Number][178]?** Height of viewport
    -   `viewport.zoom` **[Number][178]?** Zoom of viewport
    -   `viewport.pitch` **[Number][178]?** Camera angle in degrees (0 is straight down)
    -   `viewport.bearing` **[Number][178]?** Map rotation in degrees (0 means north is up)
    -   `viewport.latitude` **[Number][178]?** Latitude center of viewport on map in mercator projection
    -   `viewport.longitude` **[Number][178]?** Longitude Center of viewport on map in mercator projection
...
-   **Updaters**: [`uiStateUpdaters.setExportMapFormat`][233]
