...
![](https://d1a3f4spazzrp4.cloudfront.net/kepler.gl/documentation/api_data-flow.png)
...
Read more about [Component](components/overview.md).

## Reducer and Forward Dispatcher

![](https://d1a3f4spazzrp4.cloudfront.net/kepler.gl/documentation/api_forward-dispatch.png)
...
Read more about [Reducers](reducers/overview.md).
...
Read more about [Actions and Updaters]().

## Processors and Schema Manager

![](https://d1a3f4spazzrp4.cloudfront.net/kepler.gl/documentation/api_load-save.png)
...
Read more about [Processors]() and [Schema Manager](schemas/overview.md).
